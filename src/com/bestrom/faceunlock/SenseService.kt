...
import com.bestrom.faceunlock.controller.FaceAuthenticationController
import com.bestrom.faceunlock.controller.FaceEnrollController
import com.bestrom.faceunlock.camera.CameraUtil
import com.bestrom.faceunlock.util.Constants
import com.bestrom.faceunlock.util.PreferenceHelper
import com.bestrom.faceunlock.util.Util
import com.bestrom.faceunlock.util.SenseUserContext
...
class SenseService : Service() {
    ...
    companion object {
        ...
        private const val ALARM_FAIL_TIMEOUT_LOCKOUT = "com.bestrom.faceunlock.ACTION_LOCKOUT_RESET"
        private const val ALARM_TIMEOUT_FREEZED = "com.bestrom.faceunlock.freezedtimeout"
